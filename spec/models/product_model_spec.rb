...
RSpec.describe ProductModel, type: :model do
  ...
  context 'should not be valid if the fields are empty' do
    it 'name' do
      ...
      pm = ProductModel.new(name: '', weight: 1000, height: 4, width: 17, 
    ...
    it 'weight' do
      ...
      s = Supplier.create!(fantasy_name: 'Joao', legal_name: 'Joao pe de feijao',
                           ...
                           email: 'joao.feijao@yahoo.com', phone: '91124-7753')
      pc = ProductCategory.create!(name: 'Enlatados')
      pm = ProductModel.new(name: 'Saco de Feijao', weight: '', height: 4, width: 17, 
                            length: 22, supplier: s, product_category: pc)
    ...
    it 'height' do
      ...
      s = Supplier.create!(fantasy_name: 'Joao', legal_name: 'Joao pe de feijao',
                           ...
                           email: 'joao.feijao@yahoo.com', phone: '91124-7753')
      pc = ProductCategory.create!(name: 'Enlatados')
      pm = ProductModel.new(name: 'Saco de Feijao', weight: 1000, height: '', width: 17,
                            length: 22, supplier: s, product_category: pc)
    ...
    it 'width' do
      ...
      s = Supplier.create!(fantasy_name: 'Joao', legal_name: 'Joao pe de feijao',
                           ...
                           email: 'joao.feijao@yahoo.com', phone: '91124-7753')
      pc = ProductCategory.create!(name: 'Enlatados')
      pm = ProductModel.new(name: 'Saco de Feijao', weight: 1000, height: 4, width: '',
                            length: 22, supplier: s, product_category: pc)
    ...
    it 'length' do
      ...
      s = Supplier.create!(fantasy_name: 'Joao', legal_name: 'Joao pe de feijao',
                           ...
                           email: 'joao.feijao@yahoo.com', phone: '91124-7753')
      pc = ProductCategory.create!(name: 'Enlatados')
      pm = ProductModel.new(name: 'Saco de Feijao', weight: 1000, height: 4, width: 17,
  ...
  context 'must not be valid if the fields are less than one' do
    it 'weight' do
      ...
      s = Supplier.create!(fantasy_name: 'Joao', legal_name: 'Joao pe de feijao',
                           ...
                           email: 'joao.feijao@yahoo.com', phone: '91124-7753')
      pc = ProductCategory.create!(name: 'Enlatados')
      pm = ProductModel.new(name: 'Vaca', weight: 0, height: 140, width: 143,
    ...
    it 'height' do
      ...
      s = Supplier.create!(fantasy_name: 'Joao', legal_name: 'Joao pe de feijao',
                           ...
                           email: 'joao.feijao@yahoo.com', phone: '91124-7753')
      pc = ProductCategory.create!(name: 'Enlatados')
      pm = ProductModel.new(name: 'Vaca', weight: 100000, height: 0, width: 143,
                            length: 138, supplier: s, product_category: pc)
    ...
    it 'width' do
      ...
      s = Supplier.create!(fantasy_name: 'Joao', legal_name: 'Joao pe de feijao',
                           ...
                           email: 'joao.feijao@yahoo.com', phone: '91124-7753')
      pc = ProductCategory.create!(name: 'Enlatados')
      pm = ProductModel.new(name: 'Vaca', weight: 100000, height: 140, width: 0,
                            length: 138, supplier: s, product_category: pc)
    ...
    it 'length' do
      ...
      s = Supplier.create!(fantasy_name: 'Joao', legal_name: 'Joao pe de feijao',
                           ...
                           email: 'joao.feijao@yahoo.com', phone: '91124-7753')
      pc = ProductCategory.create!(name: 'Enlatados')
      pm = ProductModel.new(name: 'Vaca', weight: 100000, height: 140, width: 143,
  ...
  it 'should generate an SKU with 20 characters' do
    # Arrange
    s = Supplier.create!(fantasy_name: 'Cleber', legal_name: 'Cleber FUNCIONA POR FAVOR',
                         cnpj: '98148569511578', address: 'Av FUNCIONA FUNCIONA POR FAVOR',
                         email: 'FUNCIONA@PORFAVOR.com', phone: '91124-7753')
    pc = ProductCategory.create!(name: 'Enlatados')
    p = ProductModel.new(name: 'Saco de Feijao', weight: 1000, height: 4, width: 17,
                        length: 22, supplier: s, product_category: pc)
  ...
  it 'should generate unique SKU' do
    ...
    s = Supplier.create!(fantasy_name: 'Cleber', legal_name: 'Cleber FUNCIONA POR FAVOR',
                         ...
                         email: 'FUNCIONA@PORFAVOR.com', phone: '91124-7753')
    pc = ProductCategory.create!(name: 'Enlatados')
    p1 = ProductModel.create!(name: 'Saco de Feijao', weight: 1000, height: 4, width: 17,
                              length: 22, supplier: s, product_category: pc)
    p2 = ProductModel.new(name: 'Saco de Arroz', weight: 1000, height: 4, width: 17,
                          length: 22, supplier: s, product_category: pc)
    sku = p1.sku
