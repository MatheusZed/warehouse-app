...
describe 'User registers a bundle' do
  ...
  it 'Successfully' do
    ...
    ProductModel.create!(name: 'Taça para vinho tinto', weight: 30, height: 12, width: 10,
                         length: 10, supplier: s, product_category: pc)
    ProductModel.create!(name: 'Saco de batata rustica', weight: 1500, height: 100, width: 100,
  ...
  pending "and the supplier can't see the other supplier's product model" do
    # Arrange
    s1 = Supplier.create!(fantasy_name: 'Vinicola Miolo', legal_name: 'Miolo Fabrica de Bebidas LTDA',
                          cnpj: '30605809000108', address: 'Av Cabernet, 100',
                          email: 'contato@miolovinhos.com', phone: '71 91124-7753')
    ...
    ProductModel.create!(name: 'Taça para vinho tinto', weight: 30, height: 12, width: 10,
                         length: 10, supplier: s1, product_category: pc1)
    ProductModel.create!(name: 'Vinho Rose', weight: 1000, height: 100, width: 100,
                         length: 100, supplier: s1, product_category: pc1)
    ProductModel.create!(name: 'Boneco do Batman', weight: 500, height: 100, width: 100,
                         length: 100, supplier: s2, product_category: pc2)
    ProductModel.create!(name: 'Boneco do Homem-Aranha', weight: 500, height: 100, width: 100,
                         length: 100, supplier: s2, product_category: pc2)
    ProductModel.create!(name: 'Boneco do Mutano', weight: 500, height: 100, width: 100,
                         length: 100, supplier: s2, product_category: pc2)
    user = User.create!(email: 'joao@email.com', password: 'admino')
